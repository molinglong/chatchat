...
export function ChatPanel({
  ...
  const { setCurrentConversationId, setConversationTitle, bumpConversationVersion, pendingContinuation, setPendingContinuation, markConversationRead } = useChatStore()
